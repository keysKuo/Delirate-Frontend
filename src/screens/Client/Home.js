                ...
                <div style={{ height: '100%' }} className="center-box">
                    ...
                    <Grid>
                        <Grid.Column mobile={12} tablet={6} computer={3}>
                            <Image style={{ width: '10vw', borderRadius: '50%' }} src={step1} />
                            <Container style={{ width: '80%', marginTop: '10px' }}>
                                Choose which products you want to enroll.
                            </Container>
                        </Grid.Column>
                        <Grid.Column mobile={12} tablet={6} computer={3}>
                            <Image style={{ width: '10vw', borderRadius: '50%' }} src={step2} />
                            <Container style={{ width: '80%', marginTop: '10px' }}>
                                Apply Delirate codes to your selected products.
                            </Container>
                        </Grid.Column>
                        <Grid.Column mobile={12} tablet={6} computer={3}>
                            <Image style={{ width: '10vw', borderRadius: '50%' }} src={step3} />
                            <Container style={{ width: '80%', marginTop: '10px' }}>
                                Products will be returned from retailer to warehouse.
                            </Container>
                        </Grid.Column>
                        <Grid.Column mobile={12} tablet={6} computer={3}>
                            <Image style={{ width: '10vw', borderRadius: '50%' }} src={step4} />
                            <Container style={{ width: '85%', marginTop: '10px' }}>
                                Delirate codes are scanned to ensure only authentic units are shipped.
                            </Container>
                        </Grid.Column>
                        <Grid.Column mobile={12} tablet={6} computer={3}>
                            <Image style={{ width: '10vw', borderRadius: '50%' }} src={step5} />
                            <Container style={{ width: '85%', marginTop: '10px' }}>
                                Customers scan to confirm authenticity, regardless of where they purchase.
                            </Container>
                        </Grid.Column>
                    </Grid>
                </div>
