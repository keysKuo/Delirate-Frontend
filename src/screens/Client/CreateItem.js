...
export default function CreateItemScreen() {
	...
	// 		navigate("/", {
	// 			state: { message: "You are allowed to access this page" },
	// 		});
	// 	}
	// }, [user, navigate]);
	...
	const handleSubmit = async (e) => {
		...
		formDataToSend.append("distributor", user.store._id);
		...
		try {
			if (
				...
				setMsg({
					...msg,
					content: "Some information still empty",
					color: "#C94E4E",
				});
			}
	...
	return (
		<Container className="w-100" alignText="left">
			...
			<div>
				<Form
					style={{
						...
						boxShadow:
							"rgba(191, 239, 217, 0.789) 10px 12px 25px 0px",
					}}
				...
				>
					...
					<Image
						...
						src={`${apiUrl}/uploads${user.store.banner}`}
					/>
					...
					<Alert css={{ color: `${msg.color}`, border: "0" }}>
						{msg.content}
					</Alert>
					<button
